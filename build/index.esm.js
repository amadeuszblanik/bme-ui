...
var GridCol = function (_a) {
    ...
    return (React.createElement(StyledCol, __assign({ size: size }, props), children));
};
...
var TopbarBrand = function (_a) {
    var children = _a.children;
    return (React.createElement(Grid$1.Col, { mobile: 1, tablet: 1, desktop: 2, alignY: "center" },
        React.createElement(Box, { alignY: "center" }, children)));
};

var TopbarContent = function (_a) {
    var children = _a.children;
    return (React.createElement(Grid$1.Col, { mobile: 3, tablet: 7, desktop: 10, alignY: "center" },
...
var Topbar = function (_a) {
    ...
    return (React.createElement(StyledTopbar, __assign({}, args),
        React.createElement(Grid$1.Container, null,
            React.createElement(Grid$1, null, children))));
};
...
var NavItem = function (_a) {
    ...
    return (React.createElement(Box, { padding: { x: 's' }, as: "button" },
...
var TextField = function (_a) {
    ...
    var _b = useState(!isEmpty(value)), filled = _b[0], setFilled = _b[1];
    ...
    return (React.createElement(Box, { width: "full" },
        React.createElement(StyledLabel, { for: name, filled: filled },
            React.createElement(Text, { size: filled ? 'xxs' : 'm' }, renderLabel(label, required))),
        React.createElement(StyledInput, { id: name, name: name, value: value, onChange: handleChange, onFocus: handleFocus, onBlur: handleBlur })));
};

var StyledSelect = styled.select(templateObject_1$d || (templateObject_1$d = __makeTemplateObject(["\n    width: 100%;\n    ", "\n    color: var(--bme-colour-text);\n    background: ", ";\n    border-radius: 5px;\n    border: var(--bme-colour-text) 1px solid;\n\n    font-size: ", "px;\n\n    appearance: none;\n    ", "\n\n    &:hover, &:active {\n        background: ", ";\n    }\n\n    &:focus {\n        border-color: ", ";\n        outline: none;\n    }\n"], ["\n    width: 100%;\n    ", "\n    color: var(--bme-colour-text);\n    background: ", ";\n    border-radius: 5px;\n    border: var(--bme-colour-text) 1px solid;\n\n    font-size: ", "px;\n\n    appearance: none;\n    ", "\n\n    &:hover, &:active {\n        background: ", ";\n    }\n\n    &:focus {\n        border-color: ", ";\n        outline: none;\n    }\n"])), spacing('padding', { x: 'm', y: { top: 'm', bottom: 'm' } }), function (_a) {
    var theme = _a.theme;
    return hexToRGBA(theme.bme.palette.dark, 0);
}, TextFontSize.m, transition(['background'], 350), function (_a) {
    var theme = _a.theme;
...
var StyledSwitch = styled.input(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n    display: none;\n    visibility: hidden;\n    appearance: none;\n"], ["\n    display: none;\n    visibility: hidden;\n    appearance: none;\n"])));
var StyledLabel$1 = styled.label(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n    width: 100%;\n"], ["\n    width: 100%;\n"])));
...
var Switch = function (_a) {
    ...
    var _b = useState(false), stateValueHasChanged = _b[0], setStateValueHasChanged = _b[1];
    var handleChange = function (_a) {
        var checked = _a.target.checked;
        setStateValueHasChanged(true);
        onChange(checked);
    };
    return (React.createElement(Box, { width: "full", padding: { x: 'm' } },
        React.createElement(StyledLabel$1, { htmlFor: name },
            React.createElement(Box, { width: "full", alignX: "justify" },
                React.createElement(Text, null, renderLabel(label, required)),
                React.createElement(Switch$1, { checked: value, variant: variant }))),
        React.createElement(StyledSwitch, { type: "checkbox", id: name, name: name, checked: value, onChange: handleChange, required: stateValueHasChanged ? required : false })));
};
Switch.defaultProps = {
    variant: 'primary',
};
...
var CharacterLimit = function (_a) {
    ...
    return isRealNumber(characters) && maxLimit ? (React.createElement(Text, { size: "xxs" },
        characters,
        " / ",
        maxLimit)) : null;
};
var Label = function (_a) {
    ...
    var stateValid = useState(valid || true)[0];
    return (React.createElement(Box, { width: "full", direction: "column" },
        React.createElement(Box, { width: "full" }, children),
        React.createElement(Box, { width: "full", alignX: "justify", padding: { y: 's', x: 'm' } },
            React.createElement(Text, { size: "xxs", variant: !stateValid ? 'required' : null }, !stateValid ? errorText : helperText),
            React.createElement(CharacterLimit, __assign({}, characterLimitProps)))));
};
Label.defaultProps = {
    helperText: '&nbsp;',
    errorText: '&nbsp;',
...
var StyledList = styled(Box)(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n    overflow: hidden;\n    border: ", " 1px solid;\n"], ["\n    overflow: hidden;\n    border: ", " 1px solid;\n"])), function (_a) {
    var borderColour = _a.borderColour, theme = _a.theme;
    return hexToRGBA(theme.bme.palette[borderColour], 0.33);
});
var StyledListItem = styled(Box)(templateObject_2$8 || (templateObject_2$8 = __makeTemplateObject(["\n    border-bottom: ", " 1px solid;\n"], ["\n    border-bottom: ", " 1px solid;\n"])), function (_a) {
    var borderColour = _a.borderColour, theme = _a.theme;
    return hexToRGBA(theme.bme.palette[borderColour], 0.33);
});
var ListItem = function (_a) {
    var children = _a.children, borderColour = _a.borderColour;
    return (React.createElement(StyledListItem, { borderColour: borderColour, direction: "column", padding: { x: 'm', y: 's' } }, children));
};
var List = function (_a) {
    ...
    return (React.createElement(StyledList, { width: "full", direction: "column", rounded: true, borderColour: borderColour, background: background }, childrenWithProps));
};
List.defaultProps = {
    borderColour: 'light',
};
...
var StyledCustomSwitch = styled.div(templateObject_1$g || (templateObject_1$g = __makeTemplateObject(["\n    display: flex;\n    ", "\n    width: ", "px;\n    height: ", "px;\n    border: solid 1px ", ";\n    background: ", ";\n    border-radius: 1000px;\n    ", ";\n    cursor: pointer;\n"], ["\n    display: flex;\n    ", "\n    width: ", "px;\n    height: ", "px;\n    border: solid 1px ", ";\n    background: ", ";\n    border-radius: 1000px;\n    ", ";\n    cursor: pointer;\n"])), makeFlex('row', 'center', 'center'), sizeToPx('l') * 2, sizeToPx('l'), function (_a) {
    var variant = _a.variant, theme = _a.theme;
...
var StyledCustomSwitchIndicator = styled.div(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n    display: inline-block;\n    width: ", "px;\n    height: ", "px;\n    margin: ", ";\n    border-radius: 1000px;\n    background: ", ";\n    ", ";\n"], ["\n    display: inline-block;\n    width: ", "px;\n    height: ", "px;\n    margin: ", ";\n    border-radius: 1000px;\n    background: ",
...
var Switch$1 = function (_a) {
    ...
    return (React.createElement(StyledCustomSwitch, { checked: checked, variant: variant, onClick: handleClick },
        React.createElement(StyledCustomSwitchIndicator, { checked: checked, variant: variant })));
};
...
export { Badge as BMEBadge, Box as BMEBox, Button as BMEButton, Card as BMECard, Form as BMEForm, GlobalStyles as BMEGlobalStyles, Grid$1 as BMEGrid, Header as BMEHeader, Image as BMEImage, List as BMEList, Nav as BMENav, Switch$1 as BMESwitch, Text as BMEText, Topbar as BMETopbar };
