...
declare type MapboxLogoPosition = 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right';
declare type MarkerAnchor = 'top' | 'bottom' | 'left' | 'right' | 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right';
