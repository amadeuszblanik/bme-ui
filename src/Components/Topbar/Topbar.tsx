...
const StyledTopbar = styled.header<TopbarStyledComponentProps>`
  ...
  ${({theme, variant}) => variant ? `--bme-colour-text: ${textColour(theme.bme.palette[variant as Palette], theme)};` : ''}
`;
        ...
        <BMEGrid>
          <BMEGrid.Col mobile={1} tablet={1} desktop={2}>
            <BMEBox alignY="center">
              {brandIsURL ? (<BMEImage source={brand} width="42px"/>) : (<BMEText fontFamily="mono">{brand}</BMEText>)}
            </BMEBox>
          </BMEGrid.Col>
